          ...
          <Accordion.Panel>
            <Stack spacing="1rem" py="1rem">
              <PermissionHelpDescription
                ...
                iconColor="success"
                name={t`Unrestricted`}
                description={t`The group can use the query builder to ask charts of any table in the database.`}
              />
              ...
              <PermissionHelpDescription
                ...
                iconColor="warning"
                name={t`Granular`}
                description={t`The group can only use the query builder to ask charts of specific tables.`}
              />
              ...
              <PermissionHelpDescription
                ...
                description={t`The group can't use the query builder or drill through existing charts. They also can't see the data in the Browse data section. They can still view charts based on this data, if they have permissions to the relevant collection.`}
              />
              ...
              <PermissionHelpDescription
                ...
                iconColor="danger"
                name={t`Block (Pro)`}
                description={t`The group can't see charts based on this the data, even if they have collection permissions to view the charts. People in a blocked group would need to be in another group with both collection permissions and data permissions in order to view the item.`}
              />
            </Stack>
          </Accordion.Panel>
        </Accordion.Item>
