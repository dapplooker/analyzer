...
const TagEditorHelp = ({
  ...
  return (
    <div className="px3 text-spaced">
      ...
      <p>
        {t`Giving a variable the "Field Filter" type allows you to link charts to dashboard filter widgets or use more types of filter widgets on your SQL question. A Field Filter variable inserts SQL similar to that generated by the GUI query builder when adding filters on existing columns.`}
      </p>
      <p>
