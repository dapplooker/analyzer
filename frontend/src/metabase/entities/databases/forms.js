  ...
  details: {
    fields: ({ id, engine, details = {} } = {}) => [
      ...
      },
      {
        ...
        description:
          t`Analyzer can scan the values present in each field in this database to enable checkbox filters in dashboards and charts. This can be a somewhat resource-intensive process, particularly if you have a very large database.` +
          " " +
