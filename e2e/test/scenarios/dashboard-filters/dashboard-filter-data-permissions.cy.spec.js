...
describe("support > permissions (metabase#8472)", () => {
  ...
  it("should not allow a nocollection user to visit the page, hence cannot see the filter", () => {
    ...
    cy.request({
      method: "GET",
<<<<<<<< HEAD:e2e/test/scenarios/dashboard/dashboard_data_permissions.cy.spec.js
      url: "/api/dashboard/1",
========
      url: `/api/dashboard/${ORDERS_DASHBOARD_ID}`,
>>>>>>>> 46c668b1e56576d67994febf129fb5cb34d3851d:e2e/test/scenarios/dashboard-filters/dashboard-filter-data-permissions.cy.spec.js
