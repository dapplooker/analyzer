...
(defn- get-dashboard
  ...
  (let [dashboard (-> (db/select-one Dashboard :id id)
                      ...
                      (hydrate [:ordered_cards [:card [:moderation_reviews :moderator_details]] :series :dashcard/action :dashcard/linkcard-info] :collection_authority_level :can_write :param_fields :param_values)
                      api/read-check
